...
describe('.createDappId()', () => {
  it('returns host:port based id', () => {
    ...
    expect(createDappId({ url: 'https://google.com:987' })).toEqual('google.com:987')
    expect(createDappId({ url: 'https://www.google.com:987' })).toEqual('google.com:987')
    expect(createDappId({ url: 'https://user:pass@www.google.com:987' })).toEqual('google.com:987')
...
describe('.extractAddressPermissions()', () => {
  it('extracts address permissions', () => {
    ...
    expect(extractAddressPermissions({
      '0xdeadbeef': 123,
      '1abc': 456,
      '0xf987edf': 789
    })).toEqual({
